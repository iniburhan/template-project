        ...
        <div class="row" id="table-hover-row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{ url('artikel/store') }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                    	@csrf
                    	<div class="row">
        ...
        <div class="modal fade" id="delete-modal{{$item->id}}">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <!-- Modal body -->
                    <form action="{{ url('kategori/delete') }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input type="hidden" name="id" value="{{$item->id}}">
                            @csrf  
