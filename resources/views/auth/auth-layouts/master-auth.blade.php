...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('template/mazer/assets/compiled/svg/favicon.svg')}}" type="image/x-icon">
  ...
  <link rel="stylesheet" href="{{asset('template/mazer/assets/compiled/css/auth.css')}}">
